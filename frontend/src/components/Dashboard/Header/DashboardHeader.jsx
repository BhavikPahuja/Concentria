    ...
    <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6 mb-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-3">
          <button
            onClick={onRefresh}
            className="px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 text-blue-600 rounded-xl transition-all duration-200 flex items-center space-x-2"
          >
          ...
          {showDeleteButton && (
            <button
              ...
              className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-600 rounded-xl transition-all duration-200 flex items-center space-x-2"
            >
