...
const LogItem = ({ log }) => {
  ...
  return (
    <div className="flex items-center space-x-4 p-4 bg-white/50 rounded-lg border border-white/20 hover:bg-white/70 transition-all duration-200">
      ...
      <div className="flex-1">
        ...
        {log.ip && <p className="text-xs text-gray-500 mt-1">IP: {log.ip}</p>}
      </div>
    </div>
  );
};
    ...
    return (
      <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-6">
        <div className="text-center py-8">
          <AiOutlineFileText className="h-12 w-12 text-gray-400 mx-auto mb-4" />
